...
if __name__ == '__main__':
    ...
    val_dataset = ValDataSetMultiPhase(new_sizes=[
        ...
        [net_config.EXPAND_SIZE_W, net_config.EXPAND_SIZE_H],
                                       ...
                                       data_path='/home/give/Documents/dataset/MedicalImage/MedicalImage/ROIMultiExpand/val'
                                       )
    val(
        val_dataset,
        ...
        load_model_path='/home/give/PycharmProjects/MedicalImage/Net/BaseNet/ResNet_3_Expand/models/5/single_val/saved/9701/',
