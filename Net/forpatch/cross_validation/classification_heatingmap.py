...
if __name__ == '__main__':
    train_features, train_labels, val_features, val_labels = \
        generate_features_labels('/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/heatingmap/crossvalidation/0')
    ...
    predicted_label = SVM.do(train_features, train_labels, val_features, val_labels, C=0.125, gamma=8)
    print predicted_label
    calculate_acc_error(predicted_label, val_labels)
