...
def distort_image(image, height, width, bbox, thread_id=0, scope=None):
  ...
  """
    with tf.op_scope([image, height, width, bbox], scope, 'distort_image'):
        ...
        distorted_image = tf.image.resize_images(distorted_image, [width, height],
                                                  resize_method)
...
def image_preprocessing(image_buffer, bbox, train, thread_id=0, image_size=128):
