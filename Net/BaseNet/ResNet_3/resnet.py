...
def inference_small(x,
    ...
    return inference_small_config(x, c, phase_names)


def inference_small_config(xs, c, phase_names):
    c['bottleneck'] = False
    c['ksize'] = 3
    c['stride'] = 1
    CONV_OUT = None
...
if __name__ == '__main__':
    ...
    ), is_training=is_training, num_classes=2, use_bias=FLAGS.use_bn,phase_names=['NC','ART','PV'],
                        num_blocks=3)
    print y
