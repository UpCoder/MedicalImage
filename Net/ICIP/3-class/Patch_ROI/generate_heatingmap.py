...
model_path = '/home/give/PycharmProjects/MedicalImage/Net/ICIP/3-class/Patch_ROI/models'
divided_liver = False
    ...
    for subclass in ['train', 'val', 'test']:
        for type in [2, 0, 1]:
            generate_heatingmaps(
                ...
                9,
                os.path.join(
                    '/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/heatingmap/ICIP/3-classes/patch_ROI',
                    subclass
                )
            )