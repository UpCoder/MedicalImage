...
class DataSet:
    ...
    def resize_images(images, size, rescale=True):
        ...
        return res
    @staticmethod
    def generate_paths(dir_name, target_labels=[0, 1, 2], label_mapping={0:0, 1:1, 2:2}, shuffle=True):
        '''
...
def train(logits, images_tensor, labels_tensor, is_training_tensor, save_model_path=None, step_width=100):
    train_dataset = DataSet('/home/give/Documents/dataset/MedicalImage/MedicalImage/Patches/ICIP/only-patch/train', 'train',
    ...
    val_dataset = DataSet('/home/give/Documents/dataset/MedicalImage/MedicalImage/Patches/ICIP/only-patch/val', 'val',
                          rescale=True, divied_liver=False, expand_is_roi=True,
                          full_roi_path='/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/train')
