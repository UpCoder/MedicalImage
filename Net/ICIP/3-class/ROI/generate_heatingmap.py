...
model_path = '/home/give/PycharmProjects/MedicalImage/Net/ICIP/Patched/models/1200.0'
divided_liver = False
...
if __name__ == '__main__':
    ...
    for subclass in ['train', 'val', 'test']:
        for type in [3, 2, 0, 1, 4]:
            generate_heatingmaps(
                '/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/ICIP/' + subclass,
                type,
                9,
                os.path.join(
                    '/home/give/Documents/dataset/MedicalImage/MedicalImage/SL_TrainAndVal/heatingmap/ICIP/only-patch',
                    subclass
                )
            )