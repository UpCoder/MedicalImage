...
def main(_):
    ...
    save_model_path = '/home/give/PycharmProjects/MedicalImage/Net/ICIP/ROI/models'
    train(logits, roi_images, labels_tensor, is_training_tensor, save_model_path=save_model_path, step_width=20)
