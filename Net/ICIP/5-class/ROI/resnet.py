...
def inference_small(x,
    ...
    return inference_small_config([x], c, phase_names, batch_size=batch_size, pointed_phase=point_phase)
...
def inference_small_config(xs_expand, c, phase_names, xs_names=['ROI', 'EXPAND'], batch_size=None,ksize=[3, 3], pointed_phase=[0, 1, 2]):
    c['bottleneck'] = False
    c['stride'] = 1
    CONV_OUT = None
    for xs_index, xs in enumerate(xs_expand):
